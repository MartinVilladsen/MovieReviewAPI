...
@Document(collection = "movies") // Lader framework vide at denne klasse er en del af collectionen
...
@NoArgsConstructor // Annotation som laver en constructor der ikke tager parameter
public class Movie {
    ...
    @DocumentReference // Databasen tager kun reviews's Id
